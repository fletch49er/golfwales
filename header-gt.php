...
include_once('php/gw_functions.php');
?>
<!DOCTYPE html>
...
<script>
  ...
  <link rel="stylesheet" type="text/css" href="<?PHP echo get_template_directory_uri(); ?>/css/gw-styles.css" />
  <link rel="stylesheet" type="text/css" href="<?PHP echo get_template_directory_uri(); ?>/css/gw-footer.css" />
