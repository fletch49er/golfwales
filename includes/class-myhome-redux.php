	...
	class My_Home_Redux {
		...
		public function set_args() {
			...
			$args = Array(
				...
				'menu_type'           => 'menu',
				'allow_sub_menu'      => true,
				'menu_title'          => esc_html__( 'GS Theme', 'myhome' ),
				'page_title'          => esc_html__( 'GS Options', 'myhome' ),
				'google_api_key'      => '',
		...
		public function set_design_options_menu() {
			...
			$args  = Array(
				...
				'display_name'        => esc_html__( 'GS Design', 'myhome' ),
				'display_version'     => $theme->get( 'Version' ),
				'menu_type'           => 'menu',
				'allow_sub_menu'      => true,
				'menu_title'          => esc_html__( 'GS Design', 'myhome' ),
				'page_title'          => esc_html__( 'GS Design', 'myhome' ),
				'google_api_key'      => '',
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://myhometheme.zendesk.com/hc/en-us/articles/360003770253#twitter">' .
						              ...
						              '<strong>' . admin_url( 'admin-post.php?action=myhome_social_login_callback_twitter' ) . '</strong>',
						'type'     => 'switch',
						'default'  => false,
						'required' => array(
							array( 'mh-social_login', '=', true )
