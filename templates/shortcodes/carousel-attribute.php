...
if ( count( $myhome_terms ) ) :
	...
	if ( isset( $myhome_attribute_carousel['more_page'] ) && $myhome_attribute_carousel['more_page'] ) : ?>
        <div class="text-center mh-margin-bottom-small">
            <a class="mdl-button mdl-button--lg mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" href="<?php echo esc_url( $myhome_attribute_carousel['more_page'] ); ?>" title="<?php echo esc_attr( $myhome_attribute_carousel['more_page_text'] ); ?>">
