...
<?php if ( isset( $myhome_estate_list['more_page'] ) && $myhome_estate_list['more_page'] ) : ?>
    <div class="text-center mh-margin-bottom-small mh-margin-top-small">
        <a class="mdl-button mdl-button--lg mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" href="<?php echo esc_url( $myhome_estate_list['more_page'] ); ?>" title="<?php echo esc_attr( $myhome_estate_list['more_page_text'] ); ?>">
