...
if ( $myhome_idx_widget['class'] == 'mh-idx-widget mh-idx-widget__carousel' ) {
	...
	<style>
		@media (min-width: 768px) {
			...
			#<?php echo esc_html($myhome_idx_widget['id']); ?> .IDX-carouselCell {
				min-width: <?php echo esc_html($myhome_idx_widget['carousel_width']); ?>px !important;
			}
		}

        #<?php echo esc_html($myhome_idx_widget['id']); ?> .IDX-carouselContainer {
			background-color: <?php echo esc_html($myhome_idx_widget['carousel_card_bg']); ?> !important;
		}
	</style>
	<?php
