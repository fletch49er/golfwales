...
<?php if ( isset( $myhome_agents_list['more_page'] ) && $myhome_agents_list['more_page'] ) : ?>
    ...
    <div class="text-center mh-margin-bottom-small">
        <a class="mdl-button mdl-button--lg mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" href="<?php echo esc_url( $myhome_agents_list['more_page'] ); ?>" title="<?php echo esc_attr( $myhome_agents_list['more_page_text'] ); ?>">
