...
<section class="mh-estate__agent">
	<div class="mh-widget-title">
		<h3 class="mh-widget-title__text">
			<a href="<?php echo esc_url( $myhome_agency->get_link() ); ?>" title="<?php echo esc_attr( $myhome_agency->get_name() ); ?>">
				<span itemprop="name"><?php echo esc_html( $myhome_agency->get_name() ); ?></span>
			</a>
		</h3>
	</div>
			...
			<?php if ( $myhome_agency->has_phone() ) : ?>
				<div class="mh-estate__agent__phone">
					<a href="tel:<?php echo esc_attr( $myhome_agency->get_phone_href() ); ?>">
						...
						<span itemprop="telephone"><?php echo esc_html( $myhome_agency->get_phone() ); ?></span>
					</a>
				</div>
			<?php endif; ?>
